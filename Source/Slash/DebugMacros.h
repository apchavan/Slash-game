...
#define DRAW_COLORED_SPHERE(Location, Color) \
	if (GetWorld()) \
		DrawDebugSphere(GetWorld(), Location, 50.f, 24, Color, true);

#define DRAW_COLORED_BOX(Location, Color) \
	if (GetWorld()) \
		DrawDebugBox(GetWorld(), Location, Location * FVector(1.5f, 0.5f, 0.5f), Color, true, -1.f, 0u, 1.f);
